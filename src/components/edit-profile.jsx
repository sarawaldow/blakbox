...
export const EditProfile = () => {
    ...
    const [dummyUserCity, setDummyUserCity] = useState(userCity);
        ...
        <div className="editProfileWrapper">
            ...
            {!showSuccessfullyEdited && (
                <div>
                        ...
                        <div className="inputWrapper">
                            ...
                            <div className="flexEndWrapper">
                                ...
                                <input
                                    ...
                                    value={dummyUserCity}
                                    onChange={(e) => {
                                        setDummyUserCity(e.target.value);
                                        setChangesMade(true);
                                    }}
                                />
                            </div>
                    ...
                    <p>
                        Die mit * gekennzeichneten Informationen sind nur für
                        den Box-Owner sichtbar
                    </p>
                </div>
            )}
        </div>
